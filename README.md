...
|-------------------------------------------------------------------------------------------------------------|-----------------------------------------|---------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [changelog.yml](https://github.com/alejandrohdezma/.github/blob/master/workflows/changelog.yml)             | `.github/workflows/changelog.yml`       | Releases                        | Fully automated changelog generation. Generates a `CHANGELOG.md` file based on tags, issues and merged pull requests (and separates them into designated categories based on their labels). The exact configuration can be found [here](https://github.com/alejandrohdezma/.github/blob/master/workflows/changelog.yml#L36). An example of a generated changelog file can be found [here](https://github.com/alejandrohdezma/sbt-fix/blob/master/CHANGELOG.md). |
